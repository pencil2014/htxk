    ...
    <div class="content detail" v-if="goods_detail">
      <e-cellbox class="top" >
        ...
        <e-cell-item class="top-info">
          ...
          <!-- <sku-select @selectedItemsAction='selectedItemsAction' @selectedSkuList="selectedSkuList" :linkTo="'/apply/t?id=' + route.query.id + '&skuCode=' + " /> -->
          <sku-select @selectedItemsAction='selectedItemsAction' @selectedSkuList="selectedSkuList" linkTo="/apply/t" />
      ...
      <div class="main">
        <el-tabs v-model="activeName" class="large">
          <el-tab-pane label="图文详情" name="first">
            <el-row class="third-parttern-info">
              <span class="tpi-title">主办方信息： </span>
              <span class="tpi-photo"><e-avatar :size='[40,40]' :src="goods_detail.thirdPatternIconUrl" :alt="goods_detail.thirdPatternNickname"></e-avatar></span>
              <span class="tpi-text">{{goods_detail.thirdPatternNickname}}</span>
            </el-row>
