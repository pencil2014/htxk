<template>
  <div class="coterie-info" v-if='coterieData'>
    <div class="clearfix">
      <div class="index fl">
        <dt class="img">
          <e-avatar :size='[100, 100]'  :src='coterieData.icon' />
        </dt>
      </div>
      <div class="info fl">
        <div >
          ...
          <el-button type="text"  size="small" class="fr" 
            @click='operateInApp' 
            v-if='isMine'>
            <i class="icon iconfont" >&#xe6bc;</i>
            成员管理
...
export default {
  ...
  methods: {
    ...
    bdInit () {
      ...
      let sharePic = this.coterieData.icon || (baseUrl + '/images/app_logo.png')
      let shareUrl = baseUrl + '/share?type=coterie&shareId=' + this.coterieData.circleId + '&share='
