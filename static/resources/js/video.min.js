...
t.Hb=function(){u.Ed();u.o(document,"mousemove",this.P.move,l);u.o(document,"mouseup",this.P.end,l);u.o(document,"touchmove",this.P.move,l);u.o(document,"touchend",this.P.end,l);this.update()};t.update=function(){if(this.a){var a,c=this.xb(),d=this.handle,e=this.Rc;isNaN(c)&&(c=0);a=c;if(d){a=this.a.offsetWidth;var g=d.u().offsetWidth;a=g?g/a:0;c*=1-a;a=c+a/2;d.u().style.left=u.round(100*c,2)+"%"}e.u().style.width=u.round(100*a,2)+"%";var tempObj = e.u().previousSibling;if(tempObj && tempObj.nodeType == 1) {var prevEl = e.u().previousSibling;var barWidth=parseFloat(e.u().style.width)||0;var loadWidth=parseFloat(prevEl.style.width)||0;if(barWidth>=loadWidth){loadWidth=barWidth;}prevEl.style.width=loadWidth+ '%';}}};
