...
(function(i) {
	...
	if (function(g) {
		...
		i.fn.tn3.config = {
			...
			skin: null,
			skinDir: "skins",
			skinDefault: '<div class="tn3-gallery"><div class="tn3-count"></div><div class="tn3-text-bg"><div class="tn3-image-title"></div><div class="tn3-image-description"></div></div><div class="tn3-next tn3_v tn3_o"></div><div class="tn3-prev tn3_v tn3_o"></div><div class="tn3-next-page"></div><div class="tn3-prev-page"></div><div class="tn3-image"><div class="tn3-preloader tn3_h tn3_v"><img src="preload.gif"/></div><div class="tn3-timer"></div></div><div class="tn3-controls-bg tn3_rh"><div class="tn3-sep1"></div><div class="tn3-sep2"></div><div class="tn3-sep3"></div></div><div class="tn3-thumbs"></div><div class="tn3-fullscreen"></div><div class="tn3-show-albums"></div><div class="tn3-play"></div><div class="tn3-albums"><div class="tn3-inalbums"><div class="tn3-album"></div></div><div class="tn3-albums-next"></div><div class="tn3-albums-prev"></div><div class="tn3-albums-close"></div></div></div>',
			cssID: null
		};
	...
	i.fn.tn3.Gallery.prototype = {
					...
					switch (n) {
						...
						case "image":
							...
							g.bind("img_click", function(k) {
								...
								f.n = f.n + 1;
								f.items.count && f.items.count.empty().append('<span class="now_page">' + f.n + "</span>" + '<span class="tips_space">/</span><span class="total_page">' + f.data[f.cAlbum].imgs.length + "</span>");
		...
		initResponsive: function(d) {
			...
			if (typeof d == "number") {
				...
				var f = this.$c.parent(),
					n = (this.config.width == null ? this.config.initValues.width :
						this.config.width) / (this.config.height == null ? this.config.initValues.height : this.config.height),
					g = f.width(),
					l = f.height();
			...
			if (this.items.preloader)
				if (d) {
					...
					if (this.config.spinjs)
						if (this.spinner) this.spinner.spin(this.items.preloader[0]);
...
(function(i, b, a) {
	...
	(function() {
		...
		!h(p, "transform") && p.adj ? (m.addRule(".spin-vml", "behavior:url(#default#VML)"), u.prototype.lines = function(r, s) {
			...
			if (s.shadow)
				for (x = 1; x <= s.lines; x++) w(x, -2, "progid:DXImageTransform.Microsoft.Blur(pixelradius=2,makeshadow=1,shadowopacity=.3)");
			...
			if (this.isInTransition) this.qid = b;
				...
				if (this.data[b]) {
					...
					if (this.cached[b] != undefined)
						if (this.cached[b].status == "loaded") this.initImage(b);
						else {
...
(function(i) {
	...
	i.fn.tn3.Thumbnailer.prototype = {
		...
		thumbsLoaded: function() {
			...
			this.$ul.find("li").last().css("margin-right", "0");
			this.centerList();
			this.trigger("load")
		},
		...
		slide: function() {
			...
			if (b <= this.config.buffer) {
				...
				if (b >= this.containerSize - this.config.buffer) {
		...
		a = b.prototype = {
			...
			animateGrid: function(c, e, d, h, j, f, n) {
				...
				for (d = 0; d < c.length; d++) {
					...
					if (i.isArray(c[d]))
						for (var k in c[d]) c[d][k].delay(h).animate(e[d], g);
