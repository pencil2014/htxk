            ...
            domUtils.on(tabs[i], "click", function (e) {
                ...
                for (j = 0; j < tabs.length; j++) {
                    ...
                    if(tabs[j] == target){
                        ...
                        if(bodyId == "online"){
                        	onlineVideo = onlineVideo || new OnlineVideo('fileList');
                        }
                    }else {
    ...
    OnlineVideo.prototype = {
        ...
        getFileData: function () {
            ...
            if(!_this.listEnd && !this.isLoadingData) {
                ...
                ajax.request(editor.getActionUrl(editor.getOpt('videoListActionName')), {
                    timeout: 100000,
                    data: utils.extend({
        ...
        pushData: function (list) {
            ...
            for (i = 0; i < list.length; i++) {
                if(list[i] && list[i].url) {
                    ...
                    if ( "wmv|avi|mkv|rmvb|rm|flv|mp4|mov|3gp|mpg|mpeg".indexOf(filetype) != -1 ) {
                        preview = document.createElement('img');
                        domUtils.on(preview, 'load', (function(image){
                            return function(){
                                _this.scale(image, image.parentNode.offsetWidth, image.parentNode.offsetHeight,'justify');
                            };
                        })(preview));
                        preview.width = 113;
                        preview.setAttribute('src', urlPrefix + "/" + list[i].image + (list[i].url.indexOf('?') == -1 ? '?noCache=':'&noCache=') + (+new Date()).toString(36) );
                    }
//                    else {
